...
This means the underlying limitation described above — the MPC does not manufacture a tracking error ahead of a corner it hasn't reached yet — remains open as of this writing.
