...
| Speed-target deficit cap | `sim/rollout_core.py` (`SPEED_TARGET_DEFICIT_MAX`) | `fsds_simulator/.../mpc/mpc_controller.py` (same name) | `2.5` m/s, module constant on both sides, no ROS param/launch-arg override |
