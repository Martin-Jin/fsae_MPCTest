...
CURVATURE_SPEED_A_LAT_MAX = 4.75
...
def peak_kappa_ahead(waypoints, scan_end=6.0):
    ...
    Numeric-parity port of
    fsds_simulator/control/fsae_control/fsae_control/control_utils.py's
    peak_kappa_ahead() (which is itself a near-verbatim copy of that file's
    curvature_speed), so the offline and live output-smoothing lookahead
    fades see the identical signal.
    ...
    purely current-state signal fades too late on a track with short
